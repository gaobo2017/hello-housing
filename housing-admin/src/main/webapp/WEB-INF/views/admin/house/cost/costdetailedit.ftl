...
<div class="wrapper">
	<div class="formbox-a">
		<h2 class="h2-title">修改成本明细信息<span class="s-poar"><a class="a-back" href="${domainUrlUtil.EJS_URL_RESOURCES}/admin/costdetail/manage">返回</a></span></h2>
		
		<#--1.addForm----------------->
		<div class="form-contbox">
			<@form.form method="post" class="validForm" id="addForm" name="addForm" enctype="multipart/form-data">
			<input type="hidden" id="id" name="id" value="${(housingCostDetail.id)!''}">
			<dl class="dl-group">
				<dt class="dt-group"><span class="s-icon"></span>成本明细信息</dt>
				<dd class="dd-group">
					<div class="fluidbox">
						<p class="p12 p-item">
